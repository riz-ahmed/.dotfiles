...
Plug 'neoclide/coc.nvim', {'branch': 'release'}		"autocompletion, parsing, code-formating
call plug#end()
...
xmap <silent> <leader>rl  <Plug>(coc-codeaction-refactor-selected)
nmap <silent> <leader>rl  <Plug>(coc-codeaction-refactor-selected)
...
" Manage extensions
nnoremap <silent><nowait> <space>me  :<C-u>CocList extensions<cr>
" Show commands
