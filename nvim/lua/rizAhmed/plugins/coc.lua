-- the entire config example for the github repo
...
keymap("x", "<leader>fs", "<Plug>(coc-format-selected)", {silent = true})
keymap("n", "<leader>fs", "<Plug>(coc-format-selected)", {silent = true})
...
keymap("x", "<leader>rl", "<Plug>(coc-codeaction-refactor-selected)", { silent = true })
keymap("n", "<leader>rl", "<Plug>(coc-codeaction-refactor-selected)", { silent = true })
...
keymap("n", "<space>ld", ":<C-u>CocList diagnostics<cr>", opts)
-- Manage extensions
keymap("n", "<space>me", ":<C-u>CocList extensions<cr>", opts)
-- Show commands
